...
import { StyleSheet, Text, View, Alert, ScrollView, TextInput, TouchableOpacity, SafeAreaView } from 'react-native';
...
export default class App extends React.Component {
  ...
  onSave = async () => {
    ...
    try {
      ...
      Alert.alert('Error', `There was an error while saving the post: ${e}`)
      this.onLoad()
    }
  };
